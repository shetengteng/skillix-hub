...
```
[2026-02-18 14:30:05] [INFO] [embedding] 加载本地模型 BAAI/bge-small-zh-v1.5 从 ~/.memory-skill/models/
...
- **开发/安装目录**：`skills/memory-skill/logs/`（源代码中）
- **运行时目录**：`.cursor/skills/memory-skill/logs/`（安装后的运行时日志）
