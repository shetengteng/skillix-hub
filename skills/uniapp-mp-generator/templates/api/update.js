/**
 * 更新{{MODULE_NAME_CN}}
 * @module pages/{{MODULE_NAME_LOWER}}/api/update{{MODULE_NAME}}
 * @since {{DATE}}
 * 
 * 模板变量：
 ...
 */
export async function update{{MODULE_NAME}}(id, data) {
  try {
    ...
    checkEmasError(res, '更新{{MODULE_NAME_CN}}')

    return { success: true }
  } catch (error) {
    console.error('[update{{MODULE_NAME}}] 失败:', error)
    return { success: false, error: error.message }
  }
}

export default update{{MODULE_NAME}}
