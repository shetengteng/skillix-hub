...
# 生成 Skill
node tool.js generate '{"id":"ext-xxx","skillName":"my-api-client","target":"~/.cursor/skills/my-api-client"}'
...
Agent:
  ...
  3. 用户确认 → analyze + generate
  4. 安装到 ~/.cursor/skills/stripe-api/
```
...
Agent:
  ...
  4. generate → 生成 device-controller Skill
```
